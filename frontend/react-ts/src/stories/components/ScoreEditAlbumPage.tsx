...
function ScoreEditAlbumPage({ stars, score, setScore, setStars, albumId }: StarEditProps) {
  ...
  return (
    <Container>
      {' '}
      <StarCard>
        <Text fontSize="20px" fontFamily="SB" margin="20px 0 10px 0">
          내 별점
        </Text>
        <ScoreBox>
          <Text fontSize="15px" fontFamily="SB" margin="10px 0 10px 0" color={colors.Font_grey}>
            {startext}
          </Text>
          <StarsArea>
