  ...
  return (
    <PlayListCardContainer gradient={playlistGradient}>
      <PlayListInfoArea>
        ...
        <svg onClick={() => CreateYoutubePlaylist(playlistInfo.id)} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill={colors.BG_lightgrey} className="bi bi-youtube" viewBox="0 0 16 16">
