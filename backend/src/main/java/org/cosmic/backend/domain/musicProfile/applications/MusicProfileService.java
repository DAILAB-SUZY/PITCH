...
public class MusicProfileService {
    ...
    @Autowired
    AlbumChatService albumChatService;
    @Autowired
    ...
    public ActivityDetail openActivity(Long userId) {
        ...
        activityDetail.setPostDetail(postService.openPost(userId));//특정유저의 포스트들
        activityDetail.setAlbumChatDetail(albumChatService.openUserAlbumChat(userId));//특정 유저의 앨범챗 댓글들
