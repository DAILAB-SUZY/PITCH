...
public class LikeService {
   ...
   */
  public LikeService(PostLikeRepository postLikeRepository, UsersRepository usersRepository,
  ...
  public LikeReq createLike(Long userId, Long postId) {
    ...
    Optional<PostLike> postLike = postLikeRepository.findByPost_PostIdAndUser_UserId(postId,
        userId);
  ...
  public void deleteLike(Long user_id, Long post_id) {
    postLikeRepository.findByPost_PostIdAndUser_UserId(post_id, user_id)
