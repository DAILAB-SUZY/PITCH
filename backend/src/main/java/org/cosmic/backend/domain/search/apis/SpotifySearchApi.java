...
public class SpotifySearchApi {
  ...
  public ResponseEntity<List<SpotifySearchArtistResponse>> searchArtist(
      ...
      @PathVariable String name) throws JsonProcessingException { //q는 검색어
    return ResponseEntity.ok(
        searchArtistService.searchArtist(createSpotifyToken.accesstoken(), name));
  }
  ...
  public ResponseEntity<SpotifySearchAlbumResponse> searchAlbumId(
    ...
    return ResponseEntity.ok(
        searchAlbumService.searchAlbumId(createSpotifyToken.accesstoken(), albumId));
  }
  ...
  public ResponseEntity<List<SpotifySearchAlbumResponse>> searchAlbumByArtistId(
    ...
    return ResponseEntity.ok(
        searchArtistService.searchAlbumByArtistId(createSpotifyToken.accesstoken(), artistId));
  }
