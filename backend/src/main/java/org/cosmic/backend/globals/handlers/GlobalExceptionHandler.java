...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handlerInternalServerErrorException(
  ...
  public ResponseEntity<ErrorResponse> handlerPayLoadTooLargeException(PayLoadTooLargeException e) {
    ErrorResponse errorResponse = new ErrorResponse(HttpStatus.PAYLOAD_TOO_LARGE.value(),
        e.getMessage());
    return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE).body(errorResponse);
  }

  @ExceptionHandler(UnSupportedMediaTypeException.class)
  public ResponseEntity<ErrorResponse> handlerUnSupportedMediaTypeException(
