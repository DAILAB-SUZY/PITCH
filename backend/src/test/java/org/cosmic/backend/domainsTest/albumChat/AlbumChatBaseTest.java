...
public class AlbumChatBaseTest extends BaseSetting {
    ...
    public void setUp() {
        ...
        if(albumChatComment == null){
            albumChatComment = albumChatCommentRepository.findByAlbum_AlbumId(album.getAlbumId()).get().get(0);
            albumChatComment2 = albumChatCommentRepository.findByAlbum_AlbumId(album.getAlbumId()).get().get(1);
        }
