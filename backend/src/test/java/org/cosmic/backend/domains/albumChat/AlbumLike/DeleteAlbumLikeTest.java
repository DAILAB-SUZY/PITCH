...
@Log4j2
public class DeleteAlbumLikeTest {
    @Autowired
    ...
    public void DeleteAlbumlikeTest() throws Exception {
        ...
        AlbumChatAlbumLikeReq albumChatAlbumLikeReq = mapper.readValue(content, AlbumChatAlbumLikeReq.class); // 응답 JSON을 PostDto 객체로 변환
